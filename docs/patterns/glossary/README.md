...
eq<Int>()
// arrow.instances.IntEqInstance@4c55a5a9
```
...
// arrow.data.ListKApplicativeInstanceImplicits$instance$1@387a3d5d
```
...
// arrow.core.OptionApplicativeInstanceImplicits$instance$1@7cf90c7f
```
